  ...
  return (
    <aside className="min-w-[300px] max-w-[220px] my-[18px] ml-[35px] border-2  border-aside-border bg-aside-fill rounded-3xl overflow-hidden">
      ...
      <div className="flex items-center justify-center p-4">
        <button className="text-start-game h-[45px] w-[166px] border-aside-border rounded-2xl btn btn-outline p-4 bg-heading-fill">
          Start Game
        </button>
      </div>
      ...
      <div className="flex flex-col  ml-12 gap-1">
        <div className="flex flex-row gap-[30px] border-2  border-transparent p-3 hover:bg-black hover:border-heading-fill hover:border-2 hover:rounded-l-xl">
          ...
          <div> <h1 className="font-saira-condensed font-bold text-xl">DashBoard</h1></div>
        </div>
        ...
        <div className="flex flex-row gap-[30px] border-2  border-transparent p-3 hover:bg-black hover:border-heading-fill hover:border-2 hover:rounded-l-xl">
          ...
          <div><h1 className="font-saira-condensed font-bold text-xl">LeaderBoard</h1></div>
        </div>
        ...
        <div className="flex flex-row gap-[30px] border-2  border-transparent p-3 hover:bg-black hover:border-heading-fill hover:border-2 hover:rounded-l-xl">
          ...
          <div>
            <h1 className="font-saira-condensed font-bold text-xl">Chat</h1>
            </div>
        </div>
        ...
        <div className="flex flex-row gap-[30px] border-2  border-transparent p-3 hover:bg-black hover:border-heading-fill hover:border-2 hover:rounded-l-xl">
          ...
          <div>
            <h1 className="font-saira-condensed font-bold text-xl">Profile</h1>
            </div>
        </div>
        ...
        <div className="flex flex-row gap-[30px] border-2  border-transparent p-3 hover:bg-black hover:border-heading-fill hover:border-2 hover:rounded-l-xl">
          ...
          <div>
            <h1 className="font-saira-condensed font-bold text-xl">Settings</h1>
            </div>
        </div>
        {/* <input type="checkbox" /> */}
      </div>

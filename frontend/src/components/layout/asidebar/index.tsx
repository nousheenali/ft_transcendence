...
const AsideBar = () => {
  ...
  return (
    <aside className="min-w-[215px] max-w-[215px] my-[18px] ml-[35px] border-2 border-aside-border bg-aside-fill rounded-xl">
      <div className=" flex  justify-between w-17 h-17   border-b-indigo-500 border-b-2 p-2">
        <div className="flex ">
          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="22" viewBox="0 0 21 22" fill="none">
            <rect width="21" height="22" rx="10.5" fill="#9E9FA4" fill-opacity="0.7" />
            <rect x="0.1" y="0.1" width="20.8" height="21.8" rx="10.4" stroke="black" stroke-opacity="0.5" stroke-width="0.2" />
          </svg>
          {/* className="absolute top-[46px] left-[60px]" */}

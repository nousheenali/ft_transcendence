    ...
    return (
      <>
        <div className="flex flex-col w-full">
          ...
          <div className="flex flex-row h-[130px] border-b rounded-b-lg border-[#7E8937]">
            <div className="flex flex-shrink-0 w-1/5 justify-center">
              <img height={100} width={100} src="/av1.svg" alt="avatar" />
            </div>
            <div className="flex flex-col w-4/5 ml-2 mt-5 mb-5 mr-10 rounded-xl font-saira-condensed text-lg text-main-text justify-start pl-6 pt-1 bg-[#22272E] opacity-50">
              <div className="flex flex-row ">
                <div className="text-[#D0F223]">Name:</div>
                <div className="ml-10 truncate max-w-[300px]">{name}</div>
              </div>
              <div className="flex flex-row">
                <div className="text-[#D0F223]">Email:</div>
                <div className="ml-10 truncate max-w-[300px]">{email}</div>
              </div>
              <div className="flex flex-row">
                <div className="text-[#D0F223]">Rank:</div>
                <div className="ml-10">#{rank}</div>
              </div>
            </div>
          </div>
          <div className="border-b rounded-b-lg border-[#7E8937]">
            <ProfileNavBar />
          </div>
        </div>
      </>

...
export default function Settings() {
  return (
  <div className="bg-black h-screen w-screen top-[0px] absolute"> 
    <div className="top-[18px] right-[88px] w-[931px] h-[496px] absolute bg-[#0E1211] bg-opacity-70 rounded-[10px] border-b border-[#7E8937]">
      ...
      <div className="w-[760px] left-[36px] top-[69px] absolute gap-[74px]">
      </div>
      <div className="h-[27px] left-[407px] top-0 absolute gap-[13px]">
        <div className="text-center text-[#9E9FA4] text-[20px] font-normal">Settings</div>
      </div>
